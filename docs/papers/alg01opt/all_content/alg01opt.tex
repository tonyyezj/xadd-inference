...
\icmltitlerunning{Algorithms for 0--1 Loss Optimization in Binary Classification}

\begin{document} 

\twocolumn[
\icmltitle{Algorithms for 0--1 Loss Optimization in Binary Classification}
