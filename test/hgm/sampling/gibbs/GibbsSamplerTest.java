...
public class GibbsSamplerTest {
    public static void main(String[] args) {
        GibbsSamplerTest instance = new GibbsSamplerTest();
//        instance.makeCDFTest();
    ...
    public void testUniform() {
        ...
        GibbsSampler sampler = new GibbsSampler(context, uniform);
    ...
    public void testTriangular() {
        ...
        */
        ...
        GibbsSampler sampler = new GibbsSampler(context, triangular);
...
//        return (actualMean - expectedMean) / (Math.sqrt(expectedVariance) / Math.sqrt(numSamples));
    ...
    public void makeCDFTest() {
        ...
        GibbsSampler gs = new GibbsSampler(context, root);
        XADD.XADDNode cdf = gs.makeCumulativeDistributionFunction(root, "x");
...
//        XaddVisualizer.visualize(root, "test", context);
        ...
        GibbsSampler sampler = new GibbsSampler(context, root);
