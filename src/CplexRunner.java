...
public class CplexRunner {
	   ...
	   public static void main(String[] args) {
		  try {
		          ...
		          cplex.importModel("C:/Users/Tony/Documents/GitHub/xadd-inference/src/bucketelim/lpex1.lp");
		          double start = cplex.getCplexTime();
		          boolean solved = cplex.solve();
		          System.out.println("CPLEX Done (" + (cplex.getCplexTime() - start) + " s):");
		          if ( solved ) {
...
//		              }
	   ...
	   static void populateByRow(IloMPModeler model,
	      ...
	      double[]    ub      = {10.0, 10.0, 10.0, 1.0, 1.0};
	      String[]    varname = {"x", "y", "z", "j", "k"};
	      IloNumVarType[] xt  = {IloNumVarType.Float, IloNumVarType.Float,
                  IloNumVarType.Float, IloNumVarType.Int, IloNumVarType.Int};
	      IloNumVar[] x       = model.numVarArray(5, lb, ub, xt, varname);
	      var[0] = x;
