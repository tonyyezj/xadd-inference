...
public class KIFParser {
    ...
    public static FOPC.Term ParseTerm(Object o) {
        ...
        if (o instanceof Symbol) {
            ...
            switch (s._nID) {
                case Symbol.INTEGER:
                    return new FOPC.TInteger((Integer) s._value);
                case Symbol.DOUBLE:
                    return new FOPC.TScalar((Double) s._value);
                case Symbol.IDENT:
                    return new FOPC.TFunction((String) s._value);
                case Symbol.VARIABLE:
                    return new FOPC.TVar((String) s._value);
                default:
                    System.err.println("Expected FOL term but received " + s +
                            " at line " + s._nLine);
            }
            return null;
        }
        ...
        switch (first._nID) {
            ...
            case Symbol.TIMES: {
                ...
                switch (first._nID) {
                    case Symbol.PLUS:
                        RESULT = new FOPC.TFunction("f_add", lhs, rhs);
                        break;
                    case Symbol.MINUS:
                        RESULT = new FOPC.TFunction("f_sub", lhs, rhs);
                        break;
                    case Symbol.MOD:
                        RESULT = new FOPC.TFunction("f_mod", lhs, rhs);
                        break;
                    case Symbol.DIV:
                        RESULT = new FOPC.TFunction("f_div", lhs, rhs);
                        break;
                    case Symbol.TIMES:
                        RESULT = new FOPC.TFunction("f_mul", lhs, rhs);
                        break;
                }
            }
            break;
